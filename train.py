...
def train_freq_model(ecg_leads, ecg_labels, fs, crossval=True):
...
def train_rf_model(ecg_leads, ecg_labels, fs, crossval=True):
...
if __name__ == '__main__':
    ...
    # train_freq_model(ecg_leads, ecg_labels, fs, crossval=True)
    train_rf_model(ecg_leads, ecg_labels, fs, crossval=False)
